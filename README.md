...
- Desktop build messaging: restored Software Update panel, previous local bill
  recovery after account creation, shop update prompts, native-width thermal
  receipt printing fixes, billing-screen alignment fixes,
  inventory and dashboard layout fixes, invoice status/delete support, sales
  customised sales report download, privacy hardening, persistent login after
  system restart, restart-based update messaging, duplicate invoice-number protection,
  long thermal bill printing fixes, automatic inventory deduction after billing,
  barcode-optional products, consolidated supplier purchases, and Mac/Windows installers
...
- Windows: `https://7aakdg0aolddhlmb.public.blob.vercel-storage.com/downloads/CinchPOS-Setup.exe?v=1.0.11`
- macOS: `https://7aakdg0aolddhlmb.public.blob.vercel-storage.com/downloads/CinchPOS.dmg?v=1.0.11`
